              ...
              <form onSubmit={handleAuthAction} className="space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="relative">
                    <Mail className="absolute left-3.5 top-3 h-3.5 w-3.5 text-neutral-400" />
                    <input
                      type="email"
                      required
                      ...
                      className="w-full pl-9 pr-3 py-2 text-xs rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white/50 dark:bg-black/50 text-neutral-900 dark:text-white placeholder-neutral-400 focus:outline-none focus:ring-1 focus:ring-accent"
                    />
                  </div>
                  <div className="relative">
                    <Key className="absolute left-3.5 top-3 h-3.5 w-3.5 text-neutral-400" />
                    <input
                      type="password"
                      required
                ...
                <div className="flex flex-col sm:flex-row gap-2.5 pt-1">
                  ...
                  >
                    {authActionLoading ? 'Authenticating...' : isSignUp ? 'Create Cloud Account' : 'Log In to Dashboard'}
                  </Button>
                  ...
                  <button
                    ...
                    disabled={authActionLoading}
                    className="flex items-center justify-center space-x-2 border border-neutral-200 dark:border-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-900 text-xs px-4.5 py-2.5 rounded-xl font-bold transition-all text-neutral-700 dark:text-neutral-300"
                  >
